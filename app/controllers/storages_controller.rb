...
# storage controller manages storage related view
class StoragesController < ApplicationController
  include ItemsHelper
  before_action :check_correct_user, only: %i[index new create edit update destroy]
  ...
  def check_correct_user
    redirect_to root_path, flash: { danger: 'Not Allowed To Access' } if !user_logged_in || !user_section.storage
  end
end
