...
ActiveRecord::Schema.define(version: 2021_09_03_153004) do
  ...
  create_table "employees_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["employee_id", "item_id"], name: "index_employees_items_on_employee_id_and_item_id", unique: true
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["brand_id", "name", "category_id"], name: "index_items_on_brand_id_and_name_and_category_id", unique: true
